...
- [x] Find the stats/comparisons I used to produce values for my CERF abstract. (*located in the 'prelim_analysis_test' script*)
- [x] CERF abstract discusses differences in TRS between veg/unveg, but we haven't analyzed these samples. Will need to pull in TRS data from 2023 (but won't be able to use for stats, and these weren't collected along a transect)
...
- [ ] Are any seagrass parameters related to distance from the disturbance edge? 
   ...
   - [ ] LAI
   - [ ] Shoot density
- [x] Are any sediment parameters related to distance from the edge? 
   - [x] DBD
   - [x] Porosity
   - [x] OM content
